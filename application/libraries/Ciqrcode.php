...
class Ciqrcode
{
    ...
    // call original library (pakai path absolut CI)
    include_once APPPATH . 'third_party/qrcode/qrconst.php';
    include_once APPPATH . 'third_party/qrcode/qrtools.php';
    include_once APPPATH . 'third_party/qrcode/qrspec.php';
    include_once APPPATH . 'third_party/qrcode/qrimage.php';
    include_once APPPATH . 'third_party/qrcode/qrinput.php';
    include_once APPPATH . 'third_party/qrcode/qrbitstream.php';
    include_once APPPATH . 'third_party/qrcode/qrsplit.php';
    include_once APPPATH . 'third_party/qrcode/qrrscode.php';
    include_once APPPATH . 'third_party/qrcode/qrmask.php';
    include_once APPPATH . 'third_party/qrcode/qrencode.php';
